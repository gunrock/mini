...
#define GUNROCK_SM_TAG sm_53
#elif __CUDA_ARCH__ >= 520
  #define GUNROCK_SM_TAG sm_52
#elif __CUDA_ARCH__ >= 500
  #define GUNROCK_SM_TAG sm_50
#elif __CUDA_ARCH__ == 370
  #define GUNROCK_SM_TAG sm_37
#elif __CUDA_ARCH__ >= 350
  #define GUNROCK_SM_TAG sm_35
#elif __CUDA_ARCH__ == 320
  #define GUNROCK_SM_TAG sm_32
#elif __CUDA_ARCH__ >= 300
  #define GUNROCK_SM_TAG sm_30
#elif __CUDA_ARCH__ >= 210
  #define GUNROCK_SM_TAG sm_21
#elif __CUDA_ARCH__ >= 200
  #define GUNROCK_SM_TAG sm_20
#else
  #error "Mini Gunrock does not support builds for sm_1.x"
#endif
#else // __CUDA_ARCH__
  #define GUNROCK_SM_TAG sm_00
#endif

#define GUNROCK_LAUNCH_PARAMS(launch_box) \
  typename launch_box::GUNROCK_SM_TAG
#define GUNROCK_LAUNCH_BOUNDS(launch_box) \
  __launch_bounds__(launch_box::sm_ptx::nt, launch_box::sm_ptx::occ)

BEGIN_GUNROCK_NAMESPACE

struct GUNROCK_ALIGN(8) cta_dim_t {
  int nt, vt;
...
GUNROCK_DEVICE void restrict_forward(func_t f, int tid, int cta, int num_ctas,
  args_t... args) {
...
__global__ GUNROCK_LAUNCH_BOUNDS(launch_box)
